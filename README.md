...
In this article, I am including only the snippets of the code with represent a small portion of the actual code.

I am also constantly making changes to this project's code in [GitHub repository](https://github.com/UkiDLucas/MarketIndicators.jl).

The repository code will diverge from the examples below, hence "Read the source, Luke", look at the actual code.

If you find the information presented here useful, please visit the GitHub project and "star" and even better, "Sponsor" it.
