...
,LI_Original = data["LI"].df[:,:Original] 
,LI_Quantized = data["LI"].df[:,:Quantized] 
,LI_Avg005 = data["LI"].df[:,:Avg005] 
,LI_Avg030 = data["LI"].df[:,:Avg030] 
,LI_Avg060 = data["LI"].df[:,:Avg060] 
,LI_Avg090 = data["LI"].df[:,:Avg090] 
,LI_Avg120 = data["LI"].df[:,:Avg120] 
,LI_Avg180 = data["LI"].df[:,:Avg180] 
...
,RIDE_Original = data["RIDE"].df[:,:Original] 
,RIDE_Quantized = data["RIDE"].df[:,:Quantized] 
,RIDE_Avg005 = data["RIDE"].df[:,:Avg005] 
,RIDE_Avg030 = data["RIDE"].df[:,:Avg030] 
,RIDE_Avg060 = data["RIDE"].df[:,:Avg060] 
,RIDE_Avg090 = data["RIDE"].df[:,:Avg090] 
,RIDE_Avg120 = data["RIDE"].df[:,:Avg120] 
,RIDE_Avg180 = data["RIDE"].df[:,:Avg180] 
